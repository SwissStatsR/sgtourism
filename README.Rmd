...
[![sgtourism status badge](https://swissstatsr.r-universe.dev/badges/sgtourism)](https://swissstatsr.r-universe.dev/sgtourism)
...
The **sgtourism** R package contains the code to produce the [official St.Gallen tourism dashboard](https://ffssg.shinyapps.io/sgtourismus/).
...
Learn more about **renv** [here](https://rstudio.github.io/renv/articles/renv.html).
...
This R shiny application is transformed as an R package using the [golem](https://thinkr-open.github.io/golem/) framework.
...
Any contribution is strongly appreciated. Feel free to report a bug, ask any question or make a pull request for any remaining [issue](https://github.com/statistikSG/sgtourism/issues).
