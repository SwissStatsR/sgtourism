...
The **sgtourism** R package contains the code used to produce the [official St.Gallen Tourismus Dashboard](https://ffssg.shinyapps.io/sgtourismus/).
...
The app is built using the [golem](https://thinkr-open.github.io/golem/) R package.

To update the data, you should first replace the CSV file in the "data-raw" folder.

Then you should run the related R script in the "data-raw" folder, which will create a local RDA file in the "data" folder.
